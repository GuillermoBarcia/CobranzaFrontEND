...
const generatePalette = require(
    path.resolve(__dirname, 'projects/theme/src/@fuse/tailwind/utils/generate-palette')
);
...
const config = {
    ...
    plugins: [
        ...
        require(
            path.resolve(__dirname, 'projects/theme/src/@fuse/tailwind/plugins/utilities')
        ),
        require(
            path.resolve(__dirname, 'projects/theme/src/@fuse/tailwind/plugins/icon-size')
        ),
        require(path.resolve(__dirname, 'projects/theme/src/@fuse/tailwind/plugins/theming'))({
            themes,
        }),
